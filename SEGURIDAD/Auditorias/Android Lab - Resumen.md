...
- 🟡 `bnamas.redlink.com.ar` con **pinning nativo** (inmune a hooks Java/OkHttp/Conscrypt).
- Storage correcto (`EncryptedSharedPreferences`, `vtuapp.db` solo hashes). Frontera: Ghidra o equipo fisico.
